...
public class ArmorUpgrade : Upgrade<PlayerCharacteristics>
{
    private void Awake()
    {
    ...
    {
        float sliderValue = (float)_controllableConfig.ArmorLvl / (float)_lvlsCount;
    ...
    public override void UpgradeStat()
    {
        ...
        {
            _controllableConfig.ArmorLvl += 1;
            _controllableConfig.Armor -= _valueIncreasment;
